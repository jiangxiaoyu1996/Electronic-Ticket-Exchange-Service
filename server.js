...
async function populateDB(){
	connection = getMySQLConnection();
	connection.query('INSERT INTO event (event_name VARCHAR(255), event_ID VARCHAR(255), date VARCHAR(255), location VARCHAR(255), ticket_amount INTEGER, max_rows INTEGER, max_cols INTEGER, description TEXT) VALUES' +
	'(Bay Area Taco & Beer Festival, 1000, 11/02/2018, San Jose,CA, 500, NULL, NULL, Guests will experience unlimited pours of craft beer from local and regional breweries as well as unlimited taco tastings from some of the top restaurants & food trucks in California. In addition to the free unlimited taco tastings, restaurants & food trucks will be selling additional food and beverage items. While sampling beer and tacos, make sure to stop by our boutique vendors where you can purchase orginal art. There will also be DJ\s, games, and more!),' +
