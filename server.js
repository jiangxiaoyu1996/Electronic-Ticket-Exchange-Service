...
function populateDb(){
	...
	connection.query('INSERT INTO user (id, username, email, password, address) VALUES (1, ' + "'test'" + ', ' + "'test@gmail.com'" + ', ' + "'" + pass1 + "'" + ', ' + "'San Jose State University, San Jose, CA'" + '), (2, ' + "'time'" + ', ' + "'user1@gmail.com'" + ', ' + "'" + pass2 + "'" + ', ' + "'San Francisco'" + '), (500, NULL, ' + "'another1@gmail.com'" + ', ' + "'" + pass3 + "'" + ', ' + "'Sacramento'" + ')', function(err, rows, fields){
	});
