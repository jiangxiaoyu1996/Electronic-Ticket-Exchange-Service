...
function populateDb(){
	...
	+ '(4, ' + mysql.escape('Bay Area Taco & Beer Festival') + ', 9, 9, ' + "'another1@gmail.com'" + ', ' + "'user1@gmail.com'" + ', 28, 1), (5, ' + mysql.escape('Magnificent Mozart') + ', 1, 5, ' + 'NULL' + ', ' + "'test@gmail.com'" + ', 25, 0), (6, ' + mysql.escape('Magnificent Mozart') + ', 50, 50, ' + 'NULL' + ', ' + "'test@gmail.com'" + ', 15, 0)', function(err, rows, fields){
	});
}
